...
public class SuFatOdemeUi extends JPanel{
	...
	private void initialize() {
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				SuFatOdeme_Action_Performed(arg0);
			}
		});
	...
	protected void SuFatOdeme_Action_Performed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		GiderDao dao = new GiderDao();
		Gider gider = new Gider();
		DigerGiderler dGider = new DigerGiderler();
		dGider.setSuFatura(new BigDecimal(txtMoney.getText()));
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(SuFatOdemeUi.this, "Ýþlem Baþarýsýz Oldu");
		}
	}
}
