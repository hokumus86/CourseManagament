...
public class ElektirikFatOdemeUi extends JPanel{
	private JLabel lblFat;
	private JButton btnAdd;
	private JTextField txtMoney;

	public ElektirikFatOdemeUi() {
		initialize();
	}
	...
	private void initialize() {
		...
		lblFat = new JLabel("Elektrik Faturas\u0131 : ");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				ElektirikFatOdeme_Action_Performed(arg0);
			}
		});
	...
	protected void ElektirikFatOdeme_Action_Performed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		GiderDao dao = new GiderDao();
		Gider gider = new Gider();
		DigerGiderler dGider = new DigerGiderler();
		dGider.setElektrikFatura(new BigDecimal(txtMoney.getText()));
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(ElektirikFatOdemeUi.this, "Ýþlem Baþarýsýz Oldu");
		}
	}
}
