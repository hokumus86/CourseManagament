...
public class InternetFatOdemeUi extends JPanel{
	private JLabel lblFat;
	private JButton btnAdd;
	private JTextField txtMoney;

	public InternetFatOdemeUi() {
		initialize();
	}
	...
	private void initialize() {
		...
		lblFat = new JLabel("Ýnternet Faturas\u0131 : ");
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				InternetFatOdeme_Action_Performed(arg0);
			}
		});
	...
	protected void InternetFatOdeme_Action_Performed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		GiderDao dao = new GiderDao();
		Gider gider = new Gider();
		DigerGiderler dGider = new DigerGiderler();
		dGider.setInternetFatura(new BigDecimal(txtMoney.getText()));
		...
		try {
			...
			e.printStackTrace();
			JOptionPane.showMessageDialog(InternetFatOdemeUi.this, "Ýþlem Baþarýsýz Oldu");
		}
	}
}
