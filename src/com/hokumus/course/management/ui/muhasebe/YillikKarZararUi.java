...
public class YillikKarZararUi extends JPanel{
	private JLabel lblMoney;
	private JButton btnGetir;

	public YillikKarZararUi() {
		initialize();
	}
	...
	private void initialize() {
		...
		lblMoney = new JLabel("D\u00F6nem Y\u0131ll\u0131k Kar/Zarar : ");
		...
		btnGetir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				YillikKarZararUi_Actio_Performed(arg0);
			}
		});
	...
	protected void YillikKarZararUi_Actio_Performed(ActionEvent arg0) {
		// TODO Auto-generated method stub
		double gelir = YillikGelir_Action_Performed();
		double gider = YillikZarar_Action_Performed();
	...
	protected double YillikGelir_Action_Performed() {
		// TODO Auto-generated method stub
		...
		try {
			...
			JOptionPane.showMessageDialog(YillikKarZararUi.this, "Veritabaný iþlemlerinde hata oluþtu!!!");
			e.printStackTrace();
			return 0;
		}
	}
	
	protected double YillikZarar_Action_Performed() {
		// TODO Auto-generated method stub
